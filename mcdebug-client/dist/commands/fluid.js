import { FLUID_GET_HELP, FLUID_GROUP_HELP, FLUID_INFO_HELP, FLUID_INSERT_HELP, FLUID_EXTRACT_HELP, } from './help-text.js';
import { outputJson, outputOneLineJson, requirePos } from './util.js';
export function registerFluidCommands(parent, getApi) {
    const fluid = parent
        .command('fluid')
